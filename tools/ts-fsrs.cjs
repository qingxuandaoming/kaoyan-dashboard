// ============================================================
// ts-fsrs v5.4.2 (FSRS-6.0) —— 官方实现，原样 vendor，请勿手改
//
// 来源: https://unpkg.com/ts-fsrs/dist/index.cjs
// 许可: MIT (Copyright (c) 2026 Open Spaced Repetition)，全文见同目录 ts-fsrs.LICENSE
// 上游: https://github.com/open-spaced-repetition/ts-fsrs
//
// 为什么 vendor 而不是 npm install：
//   本项目无 package.json / node_modules，离线优先。与 src/tools/d3.min.js、
//   src/tools/katex/ 同样是落一份离线副本的做法。
//
// 升级方式：重新下载 dist/index.cjs，替换本文件正文并更新上面的版本号与哈希，
//           然后跑 node src/tools/test_fsrs_spec.js 验证行为。
//
// sha256(去本头部后的原文): abf2062dd8218357662d4dbe7cb39bc7c0e9b0be8760a5d74bb515c75321f533
// ============================================================
