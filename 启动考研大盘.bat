...
echo [1/3] 刷新笔记数据与大盘...
"%PY_EXE%" "C:\Users\92534\Desktop\考研\src\run_pipeline.py" --no-plan
if errorlevel 1 echo [提示] 流水线有报错，仍尝试打开大盘...

echo.
echo [2/3] 启动本地复习服务（闪卡练习需要）...
set "PORTFILE=C:\Users\92534\Desktop\考研\src\.serve_port"
del "%PORTFILE%" >nul 2>&1
start "考研复习服务" /MIN cmd /c ""%NODE_EXE%" "C:\Users\92534\Desktop\考研\src\serve.js""
